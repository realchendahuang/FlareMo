      ...
      <main>
        <header className="border-b border-border/60 bg-gradient-to-b from-background to-flame-50/40 py-16">
          <div className="container-x space-y-4 text-center">
            ...
            <p className="mx-auto max-w-2xl text-base text-muted-foreground">{page.subtitle}</p>
            <p className="mx-auto max-w-3xl text-sm leading-6 text-muted-foreground">{page.intro}</p>
          </div>
        </header>
              ...
              <table className="w-full text-sm">
                <tbody>
                  {page.deploymentRows.map((row) => (
                    <tr className="border-t border-border/60 first:border-t-0" key={row.label}>
                      <th className="w-1/3 px-4 py-3 text-left align-top font-medium">
                        {row.label}
                      </th>
                      <td className="px-4 py-3 align-top text-foreground">{row.value}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <section className="container-x py-16">
          <div className="space-y-6">
            <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">{page.faqHeading}</h2>
        ...
        <section className="border-t border-border/60 bg-secondary/30 py-16">
          <div className="container-x space-y-4">
            <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">{page.legalHeading}</h2>
