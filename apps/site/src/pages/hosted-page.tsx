...
const COPY = {
  "zh-CN": {
    ...
    formTitle: "收到开放通知",
    formDescription:
      "把你的邮箱留在下面，Hosted 试用开放当天会发一封邮件给你。",
    emailLabel: "邮箱",
    submit: "订阅开放通知",
    submitted: "已订阅，感谢！",
    note: "Hosted 开放前，我们不会发送任何营销邮件；Phase 2 通知发出后即可一键退订。",
    timeline:
      "Phase 0 已发布 · Phase 1（自部署多用户）进行中 · Phase 2 计划于下一季度发布",
  },
  "en-US": {
    ...
    formDescription:
      "Leave your email below; we'll send one message the day the Hosted trial opens.",
    emailLabel: "Email",
    submit: "Notify me",
    ...
    timeline:
      "Phase 0 shipped · Phase 1 (self-hosted multi-user) in progress · Phase 2 planned for the next quarter",
  },
};
