/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc apps/worker/src/worker-configuration.d.ts` (hash: b4e261dc80d6dd6f1fc57dcf4384ffda)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FLAREMO_DEPLOY_REPOSITORY" | "FLAREMO_SINGLE_USER_EMAIL" | "FLAREMO_SINGLE_USER_NAME">> {}
}
