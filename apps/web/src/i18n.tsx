...
const messages = {
  "zh-CN": {
    ...
    "usage.vectorDescription":
      "语义搜索的向量消耗（自测值，与 Cloudflare 免费额度对比）。",
    ...
    "auth.registerDescription": "创建一个属于你的工作区账户。",
    ...
    "admin.usersDescription": "查看和管理所有用户账户。",
    ...
    "memory.title": "记忆",
    "memory.subtitle": "AI 长期记住的信息，你可以随时查看、确认和纠正。",
    ...
    "projects.title": "项目",
    "projects.subtitle": "项目与任务，Agent 和脚本也能通过 API 读写。",
  ...
  "en-US": {
    ...
    "usage.vectorDescription":
      "Self-measured vector consumption for semantic search, compared against the Cloudflare allowance.",
    ...
    "auth.registerDescription": "Create a workspace account of your own.",
    ...
    "admin.usersDescription": "View and manage all user accounts.",
    ...
    "memory.title": "Memory",
    "memory.subtitle":
      "Long-term information your AI remembers. You can review, confirm, and correct it at any time.",
    ...
    "projects.subtitle":
      "Projects and tasks, readable and writable by agents and scripts through the API.",
