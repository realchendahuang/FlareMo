...
const messages = {
  "zh-CN": {
    ...
    "admin.branding.description":
      "自定义产品名称与 Logo，用于登录页、页眉和浏览器标题；留空则使用 FlareMo 默认值。",
  ...
  "en-US": {
    ...
    "admin.branding.description":
      "Customize the product name and logo shown on the sign-in page, headers, and the browser tab. Leave empty to keep FlareMo's defaults.",
